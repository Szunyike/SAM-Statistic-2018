...
Namespace Szunyi.SAM_BAM
    ...
    Public Class BAM_Optional_Filed_Manipulation
        ...
        Public Shared Sub Add(SAM As SAMAlignedSequence, Tag As String, Type As String, Value As String)
            Dim x As New Bio.IO.SAM.SAMOptionalField With {
                .Tag = Tag,
                .VType = Type,
                .Value = Value
            }
...
#End Region
        ...
        Friend Shared Function Modify_S(sAM As SAMAlignedSequence, nofNA_to_Remove_5 As Integer, nofNA_to_Remove_3 As Integer) As String
            ...
            If c.Last.Key = "S" Then
                ...
                c.Add(x)
            End If
            Return Szunyi.SAM_BAM.CIGAR.Get_CIGAR_String(c)
        End Function
...
#Region "MD_CIGARS"
        Public Shared Function GetSeqAsBioSeq(OriSeq As Bio.ISequence) As Bio.Sequence
            If OriSeq.GetType().Name = "QualitativeSequence" Then
                ...
                Dim t2 As New Bio.Sequence(Alphabets.AmbiguousDNA, t1.GetSequence) With {
                    .ID = t1.ID
                }
        ...
        Public Shared Function GetMdCIgars(SA As Bio.IO.SAM.SAMAlignedSequence, RefSeq As Bio.Sequence) As MdCIgars
            ...
            SA.QuerySequence = GetSeqAsBioSeq(SA.QuerySequence)
...
#End Region
    ...
    Public Class MdCIgars
        ...
        Public Shared Function Get_From_Line(Line As String) As MdCIgars
            Dim m As New MdCIgars With {
                .MdCIgars = New List(Of MdCigar)
            }
            Dim l = Split(Line, ":")
