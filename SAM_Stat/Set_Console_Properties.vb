...
Namespace Controls
    Public Class Set_Console_Properties
        Public Property Input_Descriptions As New List(Of Input_Description)
        ...
        Public Sub New(obj As Object)
            ...
            If t.IsClass = True Then
                ...
                For Each Prop In Props
                    ...
                    Dim t1 = Prop.GetType
                    Dim I_P As Input_Description = Prop.GetValue(obj)
                    '       Dim pinfo2 = sI_Pg2.GetType.GetProperties
                    '   Dim x1 = CType(Prop,  Input_Description)
                    ...
                    Select Case I_P.Type
                        ...
                        Case Input_Description_Type.Double
                            Dim r As New Get_Double(I_P)
                            Me.Panel1.Controls.Add(r)
                        Case Input_Description_Type.Integer
        ...
        Private Sub Set_Console_Properties_Load(sender As Object, e As EventArgs) Handles MyBase.Load
